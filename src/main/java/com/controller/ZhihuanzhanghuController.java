...
public class ZhihuanzhanghuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ZhihuanzhanghuEntity user = zhihuanzhanghuService.selectOne(new EntityWrapper<ZhihuanzhanghuEntity>().eq("zhihuanzhanghao", username));
    ...
    public R register(@RequestBody ZhihuanzhanghuEntity zhihuanzhanghu){
    	...
    	ZhihuanzhanghuEntity user = zhihuanzhanghuService.selectOne(new EntityWrapper<ZhihuanzhanghuEntity>().eq("zhihuanzhanghao", zhihuanzhanghu.getZhihuanzhanghao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ZhihuanzhanghuEntity zhihuanzhanghu, 
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZhihuanzhanghuEntity zhihuanzhanghu, 
		HttpServletRequest request){
        EntityWrapper<ZhihuanzhanghuEntity> ew = new EntityWrapper<ZhihuanzhanghuEntity>();
		PageUtils page = zhihuanzhanghuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, zhihuanzhanghu), params), params));
        return R.ok().put("data", page);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ZhihuanzhanghuEntity> wrapper = new EntityWrapper<ZhihuanzhanghuEntity>();
		if(map.get("remindstart")!=null) {
