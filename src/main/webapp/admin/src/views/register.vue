  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='zhihuanzhanghu'" class="input-group">
			   <div class="label">置换账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhihuanzhanghao" class="input" type="text" placeholder="置换账号">
			   </div>
			 </div> -->
			<el-form-item label="置换账号" class="input" v-if="tableName=='zhihuanzhanghu'">
			  <el-input v-model="ruleForm.zhihuanzhanghao" autocomplete="off" placeholder="置换账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhihuanzhanghu'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='zhihuanzhanghu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='zhihuanzhanghu'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>

			<!-- <div v-if="tableName=='zhihuanzhanghu'" class="input-group">
			   <div class="label">置换姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhihuanxingming" class="input" type="text" placeholder="置换姓名">
			   </div>
			 </div> -->
			<el-form-item label="置换姓名" class="input" v-if="tableName=='zhihuanzhanghu'">
			  <el-input v-model="ruleForm.zhihuanxingming" autocomplete="off" placeholder="置换姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhihuanzhanghu'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='zhihuanzhanghu'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(this.ruleForm.zhihuanzhanghao && (this.ruleForm.zhihuanzhanghao.length<3) && `zhihuanzhanghu` == this.tableName){
        this.$message.error(`置换账号长度不能小于3`);
        return
      }
      if(this.ruleForm.zhihuanzhanghao && (this.ruleForm.zhihuanzhanghao.length>10) && `zhihuanzhanghu` == this.tableName){
        this.$message.error(`置换账号长度不能大于10`);
        return
      }
      if((!this.ruleForm.mima) && `zhihuanzhanghu` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if(this.ruleForm.mima && (this.ruleForm.mima.length<3) && `zhihuanzhanghu` == this.tableName){
        this.$message.error(`密码长度不能小于3`);
        return
      }
      if(this.ruleForm.mima && (this.ruleForm.mima.length>10) && `zhihuanzhanghu` == this.tableName){
        this.$message.error(`密码长度不能大于10`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `zhihuanzhanghu` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if(`zhihuanzhanghu` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
